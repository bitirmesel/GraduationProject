...
namespace GraduationProject.Managers
{
    public class PronunciationManager : MonoBehaviour
    {
        ...
        private List<GameAssetItem> _levelAssets = new List<GameAssetItem>();
        ...
        public void StartPronunciationSession(List<GameAssetItem> levelData)
        {
            ...
            EnsureUIRefs();
            _levelAssets = new List<GameAssetItem>(levelData);
        ...
        private GameObject CreatePronunciationCard(GameAssetItem asset)
        {
